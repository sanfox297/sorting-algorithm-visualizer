...
import "./chunk-6X2MHZRW.js";
import "./chunk-VYKRZ4VK.js";
import "./chunk-OQTTQ3FA.js";
...
function createMuiStrictModeTheme(options) {
  ...
  return createMuiTheme_default.apply(void 0, [(0, import_utils2.deepmerge)({
...
function styled(Component) {
  var componentCreator = function componentCreator2(style) {
    ...
    if (true) {
      if (!name) {
        var displayName = (0, import_utils.getDisplayName)(Component);
    ...
    true ? StyledComponent.propTypes = _extends({
      ...
      clone: (0, import_utils.chainPropTypes)(import_prop_types.default.bool, function(props) {
